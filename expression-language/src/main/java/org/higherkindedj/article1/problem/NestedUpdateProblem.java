...
public class NestedUpdateProblem {
     ...
     *
     * <p>This seemingly simple operation requires reconstructing every
     * record in the path from root to leaf.</p>
     */
     ...
     *
     * <p>The nested loops and reconstruction become deeply nested
     * and error-prone.</p>
     */
    public static Company updateAllEmployeeStreets(Company company, String deptName, String newStreet) {
        List<Department> updatedDepts = new ArrayList<>();
