 ...
 *
 * <p>The same operations that required 20+ lines of manual reconstruction
 * become single, composable expressions with lenses.</p>
 */
public class OpticsSolution {
     ...
     *
     * <p>Compare this to the 20+ lines in {@code NestedUpdateProblem}.</p>
     */
     ...
     *
     * <p>Even more powerful: modify rather than replace.</p>
     */
    public static Department transformManagerStreet(Department dept,
     ...
     *
     * <p>Traversals let us focus on multiple values at once.</p>
     */
    public static Traversal<Department, String> allStaffStreets() {
        return Traversal.fromLens(
     ...
     *
     * <p>This operation required deeply nested loops in the manual approach.
     * With optics, we simply compose traversals.</p>
     */
    public static Department updateAllStreets(Department dept, String newStreet) {
        ...
        // Update all staff
        return allStaffStreets().modify(s -> newStreet, withManager);
    }
    ...
    public static void main(String[] args) {
        ...
        Department engineering = company.departments().get(0);
    ...
    private static void printAllAddresses(Department dept) {
        System.out.printf("  Manager - %s: %s%n",
            dept.manager().name(), dept.manager().address().street());
