...
import org.higherkindedj.article3.optics.BinaryLenses;
import org.higherkindedj.article3.optics.ExprPrisms;
import org.higherkindedj.article3.optics.Lens;
import org.higherkindedj.article3.optics.LiteralLenses;
import org.higherkindedj.article3.optics.Optionall;
import org.higherkindedj.article3.optics.Prism;
...
public final class ExprDemo {
  ...
  private static void usingPrisms() {
    System.out.println("--- Using Prisms ---\n");
    ...
    System.out.println(
        "Extract Binary from 42: " + binaryPrism.getOptional(lit).map(Binary::op));
    ...
    Expr modified =
        literalPrism.modify(
            l -> new Literal(((Integer) l.value()) * 2),
            lit);
  ...
  private static void composingOptics() {
    ...
    Optionall<Expr, Object> literalValue = literalPrism.andThen(valueLens);
    ...
    Optionall<Expr, Expr> binaryLeft = binaryPrism.andThen(leftLens);
    ...
    Expr withNewLeft =
        binaryLeft.modify(
            left -> new Binary(left, BinaryOp.MUL, new Literal(10)),
            bin);
