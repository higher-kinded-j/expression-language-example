...
This project uses **JDK 21**. The manual lens implementations demonstrate the concepts that higher-kinded-j (requiring JDK 24+) would auto-generate with `@GenerateLenses`.
...
- Setting up higher-kinded-j properly
